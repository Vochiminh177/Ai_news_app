...
from .views import article_list, article_detail, article_category, search_article, category_detail,get_all_category,update_status_article,advanced_search_article
app_name = "news"
urlpatterns = [
